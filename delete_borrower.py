...
class DeleteBorrower:
    def __init__(self, root):
        ...
        self.label = Label(self.root, text="Delete Borrower Information", fg="#1c6f9c", font=("Times New Roman", 20,"bold"))
        self.label.pack()
        ...
        self.select_button = Button(self.root, text="Delete Borrower", command=self.select_book)
